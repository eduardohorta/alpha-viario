...
|---|---|---|---|---|
| Interseção Cristiano Kraemer × Três Meninas | P1 | Adequação geométrica expressa no termo de 2009; reapresentação/ajuste prevista no aditamento de 2013 | Não individualizada | Projeto vigente, geometria executada e compatibilidade com o problema atual |
...
| Corredor Cristiano Kraemer → início do Alphaville | Eixo/P1 | Pista em duas etapas, passeios, retornos e interseção | Termo de recebimento provisório de pavimentação de trecho da Três Meninas, sem reconciliação de estacas | Mapear estacas da obra recebida e verificar seção/passeios executados |
...
| Drenagem e redes associadas | Drenagem/P6/P7 | Projetos complementares de drenagem e remanejamento de redes listados no aditamento | Não localizada | Expedientes complementares, capacidade atual e evidência de alagamento |
