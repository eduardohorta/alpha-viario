...
.PHONY: all geojson mapa respostas sonda sonda-multi pacote pacote-md data fetch-data verify-data check release-check test clean help
...
sonda-multi:      # sonda multi-fonte TomTom/HERE/Waze (setup: campo/sonda-tempos-multifonte.md)
	$(PY) scripts/coletar_tempos_multifonte.py
