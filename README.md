...
1. **Acompanhar os [pedidos LAI](relatorios/pedidos-informacao-lai.md)** (prazo ordinário 03/08) e incorporar respostas à matriz — **Pedidos 2 e 3 já incorporados (P7)**; **protocolar o Pedido 8 à PGM** (saldo das obrigações + desapropriações).
