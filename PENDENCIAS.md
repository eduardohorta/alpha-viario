...
> **Atalho:** a trilha LAI soma **15 pedidos protocolados** no e-SIC (ver [acompanhamento](relatorios/pedidos-informacao-lai.md#acompanhamento)). Os **Pedidos 11–14** (13–14/08) desdobram as respostas dos Pedidos 6 e 4 — contrapartidas viárias dos 8 empreendimentos em análise no eixo P1/P2 (11), sinalização (12), pavimentação/geometria (13) e redes de água/esgoto (14) do corredor. O **Pedido 15** (017822-26-45, 17/08, prazo 08/09) desdobra a resposta do Pedido 1 — projeto funcional/sinalização da nova interseção Costa Gama, agora na SMMU. Os itens marcados *(LAI)* abaixo dependem apenas da resposta do órgão.
