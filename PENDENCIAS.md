...
> **Atalho:** a trilha LAI soma **11 pedidos protocolados** no e-SIC (ver [acompanhamento](relatorios/pedidos-informacao-lai.md#acompanhamento)). O **Pedido 11** (13/08, protocolo 017781-26-28) desdobra a resposta do Pedido 6 — teor das contrapartidas viárias dos 8 empreendimentos em análise no eixo P1/P2. Os itens marcados *(LAI)* abaixo dependem apenas da resposta do órgão.
